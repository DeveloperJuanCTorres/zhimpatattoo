...
<div class="wa__btn_popup">
    ...
    <div class="wa__btn_popup_icon">
        <img src="{{asset('assets/img/iconos/wpp.png')}}" width="50" alt="">
    </div>
</div>


<div class="wa__popup_chat_box" style="bottom: 140px;">
    <div class="wa__popup_heading">
        <div class="wa__popup_title">Comencemos una conversación</div>
        <div class="wa__popup_intro">Elige una de nuestras opciones para iniciar una conversación por <strong>WhatsApp ;)</strong>
<div id="\&quot;eJOY__extension_root\&quot;"></div></div>
    </div>
    <!-- /.wa__popup_heading -->
    <div class="wa__popup_content wa__popup_content_left">
        <div class="wa__popup_notice">Nuestro equipo normalmente responde en pocos minutos.</div>
        
                
        <div class="wa__popup_content_list">
            				<div class="wa__popup_content_item ">
				<a target="_blank" href="https://web.whatsapp.com/send?phone=51978209130&amp;text=texto" class="wa__stt wa__stt_online">
                        ...
                        <div class="wa__popup_txt">
                            <div class="wa__member_name">Tommy Wilton</div>
                            <!-- /.wa__member_name -->
                        ...
                        <!-- /.wa__popup_txt -->
            				...
            				<div class="wa__popup_content_item ">
				<a target="_blank" href="https://web.whatsapp.com/send?phone=51978209130&amp;text=Hello, I have visited  and I need help from you. Here is link https://demo.ninjateam.org/whatsapp-chat-wordpress" class="wa__stt wa__stt_online">
				    				        <div class="wa__popup_avatar">
                        ...
                        <!-- /.wa__popup_txt -->
            				...
            				<div class="wa__popup_content_item ">
				<a target="_blank" href="https://web.whatsapp.com/send?phone=51978209130&amp;text=Hello, I have visit  and I need help from you. Here is link https://demo.ninjateam.org/whatsapp-chat-wordpress" class="wa__stt wa__stt_offline">
				    				        <div class="wa__popup_avatar">
